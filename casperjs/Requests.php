...
class Requests
{
     ...
     */
    public static function set_client_ips($client_ips)
    {
    ...
    public static function http_client($url, $method = 'GET', $fields)
    {
        ...
        curl_setopt(self::$ch, CURLOPT_COOKIEJAR, $cookie_jar); //把返回来的cookie信息保存在$cookie_jar文件中
        curl_setopt(self::$ch, CURLOPT_COOKIEFILE, $cookie_jar);
        ...
        // curl_setopt(self::$ch, CURLOPT_PORT, 8888);
